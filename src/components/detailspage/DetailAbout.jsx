    ...
    <section className="py-4">
        <div className="container ">
            <div className=" grid grid-cols-12 xl:my-20 gap-8 " >
                <div className="content col-start-1   col-end-13 xl:col-end-7 ">
                ...
                <div className="img border col-start-1 xl:col-start-8 col-end-13  ">
                    <img src="https://media.istockphoto.com/id/1423897379/photo/young-couple-sitting-on-floor-stock-photo.webp?a=1&b=1&s=612x612&w=0&k=20&c=olSMIN-NEF7PpX7FG49z_lSaxnGzvN7L2BVWeptlRNo="  className=" size-full" alt="" />
